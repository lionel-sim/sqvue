...
| `/`              | Add a focused-row filter for the active column (choose equals, contains, LIKE, `>`, `<`, or null checks; PostgreSQL also offers ILIKE; null checks apply immediately; filters use AND) |
