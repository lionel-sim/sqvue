...
type Column struct {
	...
	Default   *string
	IsPrimary bool
	// IsAutoGenerated identifies an identity or auto-increment column whose
	// value is normally supplied by the database.
	IsAutoGenerated bool
	// IsGenerated identifies a computed column that must not be supplied on
	// insert or update.
	IsGenerated bool
